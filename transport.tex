...
\begin{figure}
  \subbottom[Gnomonically projected]{%
    \includegraphics[width=0.48\linewidth]{gnomonic_cubic.png}
\label{fig:gnomonic_cubic}
  }
  \hfill
  \subbottom[Conformally projected]{%
    \includegraphics[width=0.48\linewidth]{conformal_cubic.png}
...
\begin{figure}
  \subbottom[Two-patch grid with stereographic coordinates for each patch ]{%
    \includegraphics[width=0.48\linewidth]{two-patches.pdf}
\label{fig:composite_grid}
  }
  \hfill
  \subbottom[Yin-Yang grid]{%
    \includegraphics[width=0.48\linewidth]{yin-yang.jpg}
\label{fig:yin-yang}
  }
