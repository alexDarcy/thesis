...
\paragraph{Comparing the partitioning by Scotch and Pangolin}
...
\begin{figure}
  \subbottom[Pangolin]{%
    \includegraphics[width=0.45\linewidth]{partitioning_54.pdf}
    \label{fig:pangolin_54}}
  \hfill
  \subbottom[Scotch]{%
    \includegraphics[width=0.5\linewidth]{scotch_54cores.png}
    \label{fig:scotch_54}}
  \caption{
...
\begin{figure}
  \subbottom[Pangolin]{%
    \includegraphics[width=0.45\linewidth]{partitioning_72.pdf}
    \label{fig:pangolin_72}}
  \hfill
  \subbottom[Scotch]{%
    \includegraphics[width=0.5\linewidth]{scotch_72cores.png}
    \label{fig:scotch_72}}
  \caption{
    Comparison of our algebraic partitioning
...
\subsection{Results} \label{subsec:results} A first simulation was run up to 126
...
for such small subdomains. \DIFdelbegin \DIFdel{On top of
that}\DIFdelend \DIFaddbegin \DIFadd{These results were used to estimate the number of
cores needed for a given resolution. For our target of 0.1}\degree\DIFaddend , we estimate
\DIFaddbegin \DIFadd{that up to 6144 cores can be used for an efficiency of 0.75 for 2D advection.
Furthermore, it is highly likely }\DIFaddend the chemistry will \DIFdelbegin \DIFdel{more
than }\DIFdelend \DIFaddbegin \DIFadd{allow us to }\DIFaddend double this
maximal number of cores\DIFdelbegin \DIFdel{, as for 294 cores, the total efficiency
is estimated at $0.75$}\DIFdelend .
